...
Primeira versão pública. Evolução do sistema interno OGUM v2.0 (2026-05).

### Adicionado
- Pacote `themis/` com motor único compartilhado por painel, relatório e linha de comando.
...
- Linha de comando `themis.py` (`monitorar`, `painel`, `consultar`, `testar`, `oab`).
- Lançadores para Windows (`.bat`) e macOS/Linux (`themis.sh`).
...
### Alterado
- Nome do banco: `themis.db` (compatível com o esquema anterior).
